...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_class_arms_id'), 'class_arms', ['id'], unique=False)
    ...
    sa.Column('audience', sa.String(length=50), nullable=False),
    sa.Column('class_arm_id', sa.UUID(), nullable=True),
    sa.Column('department_id', sa.UUID(), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['class_arm_id'], ['class_arms.id'], ),
    sa.ForeignKeyConstraint(['created_by'], ['users.id'], ),
    sa.ForeignKeyConstraint(['department_id'], ['departments.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('class_arm_id', sa.UUID(), nullable=False),
    ...
    sa.Column('teacher_id', sa.UUID(), nullable=False),
    sa.Column('class_arm_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['class_arm_id'], ['class_arms.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['teacher_id'], ['teachers.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('teacher_id', 'class_arm_id')
    )
    ...
    op.create_index(op.f('ix_attendance_records_class_arm_id'), 'attendance_records', ['class_arm_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_attendance_records_class_arm_id'), table_name='attendance_records')
    ...
    op.drop_index(op.f('ix_class_arms_id'), table_name='class_arms')
